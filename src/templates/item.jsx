	...
	render() {
		...
		return (
			<React.Fragment>
                ...
                <div className={cx('black-overlay', { active: this.state.isToggled === true })} onClick={this.toggleSideBar} />
                <div className="container docs-content-container">
                    ...
                    />
                    <BurgerIcon toggleSideBar={this.toggleSideBar} isToggled={this.state.isToggled} />
                    <DocsContent
                        title={post.title}
